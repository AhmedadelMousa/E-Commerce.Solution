...
namespace E_Commerce.Repository.Migrations
{
    ...
    [Migration("20250415173926_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Commerce.Core.Entities.MakeReview", b =>
                {
                    b.Property<string>("AppUserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("E_Commerce.Core.Entities.Identity.Address", b =>
                {
                    b.HasOne("E_Commerce.Core.Entities.Identity.AppUser", null)
                        .WithOne("Address")
                        .HasForeignKey("E_Commerce.Core.Entities.Identity.Address", "AppUserId")
            ...
            modelBuilder.Entity("E_Commerce.Core.Order_Aggregrate.Order", b =>
                {
                    ...
                    b.HasOne("E_Commerce.Core.Order_Aggregrate.DeliveryMethod", "DeliveryMethod")
                        .WithMany()
                        .HasForeignKey("DeliveryMethodId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.OwnsOne("E_Commerce.Core.Order_Aggregrate.AddressOrder", "ShippingAddress", b1 =>
                        {
            ...
            modelBuilder.Entity("E_Commerce.Core.Order_Aggregrate.OrderItem", b =>
                {
                    b.HasOne("E_Commerce.Core.Order_Aggregrate.Order", null)
                        .WithMany("Items")
                        .HasForeignKey("OrderId");

                    b.OwnsOne("E_Commerce.Core.Order_Aggregrate.ProductItemOrdered", "Product", b1 =>
                        {
